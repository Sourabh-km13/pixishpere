...
const SelectLocation = ({ avalibleLocation }) => {
  ...
  const getLocationImage = (location) => {
    switch (location) {
      ...
      case "Chennai":
        return "https://images.unsplash.com/photo-1616843413587-9e3a37f7bbd8?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        default:
